...
def upgrade() -> None:
    ...
    op.add_column('token_usage', sa.Column('prompt_cached_input_tokens', sa.Integer(), nullable=True))
    op.add_column('token_usage', sa.Column('prompt_cached_creation_tokens', sa.Integer(), nullable=True))
    op.add_column('token_usage', sa.Column('prompt_audio_tokens', sa.Integer(), nullable=True))
    op.add_column('token_usage', sa.Column('completion_audio_tokens', sa.Integer(), nullable=True))
    op.add_column('token_usage', sa.Column('completion_reasoning_tokens', sa.Integer(), nullable=True))
    op.add_column('token_usage', sa.Column('completion_accepted_prediction_tokens', sa.Integer(), nullable=True))
    op.add_column('token_usage', sa.Column('completion_rejected_prediction_tokens', sa.Integer(), nullable=True))
